...
export default function ComputerField({computers,remove_player_from_computer,move_player_from_computer_to_queue,make_alert,minimum_time,layoutBG}:ComputerFieldProps) {
    return (
        <div className='computer_field'>
            {layoutBG == null?
                <img src={layout.src} alt="layout" style={{borderRadius:"20px"}}></img>:
                <img src={layoutBG} alt="layout" style={{borderRadius:"20px"}}></img>
            }
