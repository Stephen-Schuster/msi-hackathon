...
export default function Sidebar({add_player,queue,pop_player_from_queue,default_computer_name,computer_name_to_index,computer_names,remove_player_from_queue,computers,nextComputerName,setNextComputerName,videogame_list}: SidebarProps) {
